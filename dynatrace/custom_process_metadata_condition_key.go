...
// CustomProcessMetadataConditionKey custom process metadata condition key
// swagger:model CustomProcessMetadataConditionKey
...
func (m *CustomProcessMetadataConditionKey) Type() string {
	return "CustomProcessMetadataConditionKey"
}
...
// Validate validates this custom process metadata condition key
...
var customProcessMetadataConditionKeyTypeAttributePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		customProcessMetadataConditionKeyTypeAttributePropEnum = append(customProcessMetadataConditionKeyTypeAttributePropEnum, v)
	}
}

// property enum
func (m *CustomProcessMetadataConditionKey) validateAttributeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, customProcessMetadataConditionKeyTypeAttributePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *CustomProcessMetadataConditionKey) validateAttribute(formats strfmt.Registry) error {
...
func (m *CustomProcessMetadataConditionKey) validateDynamicKey(formats strfmt.Registry) error {
...
func (m *CustomProcessMetadataConditionKey) UnmarshalBinary(b []byte) error {
	var res CustomProcessMetadataConditionKey
