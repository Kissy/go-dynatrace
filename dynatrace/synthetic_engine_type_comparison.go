...
// SyntheticEngineTypeComparison synthetic engine type comparison
// swagger:model SyntheticEngineTypeComparison
...
func (m *SyntheticEngineTypeComparison) Type() string {
	return "SyntheticEngineTypeComparison"
}
...
func (m *SyntheticEngineTypeComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *SyntheticEngineTypeComparison) validateOperator(formats strfmt.Registry) error {
...
func (m *SyntheticEngineTypeComparison) UnmarshalBinary(b []byte) error {
	var res SyntheticEngineTypeComparison
