...
// swagger:model OutOfMemoryDetectionConfig
...
// Validate validates this out of memory detection config
func (m *OutOfMemoryDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OutOfMemoryDetectionConfig) validateCustomThresholds(formats strfmt.Registry) error {
...
func (m *OutOfMemoryDetectionConfig) validateEnabled(formats strfmt.Registry) error {
...
func (m *OutOfMemoryDetectionConfig) UnmarshalBinary(b []byte) error {
	var res OutOfMemoryDetectionConfig
