...
func (o *ValidateManagementZone1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewValidateManagementZone1NoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewValidateManagementZone1BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewValidateManagementZone1NoContent() *ValidateManagementZone1NoContent {
	return &ValidateManagementZone1NoContent{}
}
...
func (o *ValidateManagementZone1NoContent) Error() string {
	return fmt.Sprintf("[POST /managementZones/{id}/validator][%d] validateManagementZone1NoContent ", 204)
}

func (o *ValidateManagementZone1NoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewValidateManagementZone1BadRequest() *ValidateManagementZone1BadRequest {
	return &ValidateManagementZone1BadRequest{}
}
...
func (o *ValidateManagementZone1BadRequest) Error() string {
	return fmt.Sprintf("[POST /managementZones/{id}/validator][%d] validateManagementZone1BadRequest  %+v", 400, o.Payload)
}
...
func (o *ValidateManagementZone1BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
