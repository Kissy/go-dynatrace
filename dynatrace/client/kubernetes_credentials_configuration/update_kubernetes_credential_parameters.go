...
func (o *UpdateKubernetesCredentialParams) WithBody(body *dynatrace.KubernetesCredentials) *UpdateKubernetesCredentialParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update kubernetes credential params
func (o *UpdateKubernetesCredentialParams) SetBody(body *dynatrace.KubernetesCredentials) {
	o.Body = body
}

// WithID adds the id to the update kubernetes credential params
func (o *UpdateKubernetesCredentialParams) WithID(id string) *UpdateKubernetesCredentialParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update kubernetes credential params
func (o *UpdateKubernetesCredentialParams) SetID(id string) {
	o.ID = id
}
