...
// NewGetCalculatedMetricsRumsParams creates a new GetCalculatedMetricsRumsParams object
// with the default values initialized.
func NewGetCalculatedMetricsRumsParams() *GetCalculatedMetricsRumsParams {

	return &GetCalculatedMetricsRumsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetCalculatedMetricsRumsParamsWithTimeout creates a new GetCalculatedMetricsRumsParams object
...
// NewGetCalculatedMetricsRumsParamsWithContext creates a new GetCalculatedMetricsRumsParams object
...
// NewGetCalculatedMetricsRumsParamsWithHTTPClient creates a new GetCalculatedMetricsRumsParams object
...
/*GetCalculatedMetricsRumsParams contains all the parameters to send to the API endpoint
for the get calculated metrics rums operation typically these are written to a http.Request
*/
