...
func (o *GetCalculatedMetricsRumReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCalculatedMetricsRumOK()
...
func NewGetCalculatedMetricsRumOK() *GetCalculatedMetricsRumOK {
	return &GetCalculatedMetricsRumOK{}
}
...
func (o *GetCalculatedMetricsRumOK) Error() string {
	return fmt.Sprintf("[GET /calculatedMetrics/rum/{metricKey}][%d] getCalculatedMetricsRumOK  %+v", 200, o.Payload)
}
...
func (o *GetCalculatedMetricsRumOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(dynatrace.RumMetric)
