...
func (o *ValidateCreateAwsCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewValidateCreateAwsCredentialNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewValidateCreateAwsCredentialBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewValidateCreateAwsCredentialNoContent() *ValidateCreateAwsCredentialNoContent {
	return &ValidateCreateAwsCredentialNoContent{}
}
...
func (o *ValidateCreateAwsCredentialNoContent) Error() string {
	return fmt.Sprintf("[POST /aws/credentials/validator][%d] validateCreateAwsCredentialNoContent ", 204)
}

func (o *ValidateCreateAwsCredentialNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewValidateCreateAwsCredentialBadRequest() *ValidateCreateAwsCredentialBadRequest {
	return &ValidateCreateAwsCredentialBadRequest{}
}
...
func (o *ValidateCreateAwsCredentialBadRequest) Error() string {
	return fmt.Sprintf("[POST /aws/credentials/validator][%d] validateCreateAwsCredentialBadRequest  %+v", 400, o.Payload)
}
...
func (o *ValidateCreateAwsCredentialBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
