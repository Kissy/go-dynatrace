...
func (o *GetAwsCredentialOK) Error() string {
	return fmt.Sprintf("[GET /aws/credentials/{id}][%d] getAwsCredentialOK  %+v", 200, o.Payload)
}
...
func (o *GetAwsCredentialOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(dynatrace.AwsCredentialsConfig)
