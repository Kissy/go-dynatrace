...
func (o *ValidateCreateApplicationsWebReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewValidateCreateApplicationsWebNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewValidateCreateApplicationsWebBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewValidateCreateApplicationsWebNoContent() *ValidateCreateApplicationsWebNoContent {
	return &ValidateCreateApplicationsWebNoContent{}
}
...
func (o *ValidateCreateApplicationsWebNoContent) Error() string {
	return fmt.Sprintf("[POST /applications/web/validator][%d] validateCreateApplicationsWebNoContent ", 204)
}

func (o *ValidateCreateApplicationsWebNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewValidateCreateApplicationsWebBadRequest() *ValidateCreateApplicationsWebBadRequest {
	return &ValidateCreateApplicationsWebBadRequest{}
}
...
func (o *ValidateCreateApplicationsWebBadRequest) Error() string {
	return fmt.Sprintf("[POST /applications/web/validator][%d] validateCreateApplicationsWebBadRequest  %+v", 400, o.Payload)
}
...
func (o *ValidateCreateApplicationsWebBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
