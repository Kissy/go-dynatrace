...
// NewGetApplicationsWebDefaultParams creates a new GetApplicationsWebDefaultParams object
// with the default values initialized.
func NewGetApplicationsWebDefaultParams() *GetApplicationsWebDefaultParams {

	return &GetApplicationsWebDefaultParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetApplicationsWebDefaultParamsWithTimeout creates a new GetApplicationsWebDefaultParams object
...
// NewGetApplicationsWebDefaultParamsWithContext creates a new GetApplicationsWebDefaultParams object
...
// NewGetApplicationsWebDefaultParamsWithHTTPClient creates a new GetApplicationsWebDefaultParams object
...
/*GetApplicationsWebDefaultParams contains all the parameters to send to the API endpoint
for the get applications web default operation typically these are written to a http.Request
*/
