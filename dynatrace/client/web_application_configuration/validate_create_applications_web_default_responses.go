...
func (o *ValidateCreateApplicationsWebDefaultReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewValidateCreateApplicationsWebDefaultNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewValidateCreateApplicationsWebDefaultBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewValidateCreateApplicationsWebDefaultNoContent() *ValidateCreateApplicationsWebDefaultNoContent {
	return &ValidateCreateApplicationsWebDefaultNoContent{}
}
...
func (o *ValidateCreateApplicationsWebDefaultNoContent) Error() string {
	return fmt.Sprintf("[POST /applications/web/default/validator][%d] validateCreateApplicationsWebDefaultNoContent ", 204)
}

func (o *ValidateCreateApplicationsWebDefaultNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewValidateCreateApplicationsWebDefaultBadRequest() *ValidateCreateApplicationsWebDefaultBadRequest {
	return &ValidateCreateApplicationsWebDefaultBadRequest{}
}
...
func (o *ValidateCreateApplicationsWebDefaultBadRequest) Error() string {
	return fmt.Sprintf("[POST /applications/web/default/validator][%d] validateCreateApplicationsWebDefaultBadRequest  %+v", 400, o.Payload)
}
...
func (o *ValidateCreateApplicationsWebDefaultBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
