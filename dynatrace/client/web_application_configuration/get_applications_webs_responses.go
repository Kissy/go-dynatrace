...
func (o *GetApplicationsWebsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetApplicationsWebsOK()
...
func (o *GetApplicationsWebsOK) Error() string {
	return fmt.Sprintf("[GET /applications/web][%d] getApplicationsWebsOK  %+v", 200, o.Payload)
}
...
func (o *GetApplicationsWebsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
