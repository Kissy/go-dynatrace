...
func (o *DeleteCloudFoundryCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteCloudFoundryCredentialNoContent()
...
func NewDeleteCloudFoundryCredentialNoContent() *DeleteCloudFoundryCredentialNoContent {
	return &DeleteCloudFoundryCredentialNoContent{}
}
...
func (o *DeleteCloudFoundryCredentialNoContent) Error() string {
	return fmt.Sprintf("[DELETE /cloudFoundry/credentials/{id}][%d] deleteCloudFoundryCredentialNoContent ", 204)
}

func (o *DeleteCloudFoundryCredentialNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
