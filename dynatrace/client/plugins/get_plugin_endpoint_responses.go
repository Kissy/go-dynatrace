...
func (o *GetPluginEndpointOK) Error() string {
	return fmt.Sprintf("[GET /plugins/{id}/endpoints/{endpointId}][%d] getPluginEndpointOK  %+v", 200, o.Payload)
}
...
func (o *GetPluginEndpointOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(dynatrace.RemotePluginEndpoint)
