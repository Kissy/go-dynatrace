...
func (o *ValidateCreatePluginEndpointReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewValidateCreatePluginEndpointNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewValidateCreatePluginEndpointBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewValidateCreatePluginEndpointNoContent() *ValidateCreatePluginEndpointNoContent {
	return &ValidateCreatePluginEndpointNoContent{}
}
...
func (o *ValidateCreatePluginEndpointNoContent) Error() string {
	return fmt.Sprintf("[POST /plugins/{id}/endpoints/validator][%d] validateCreatePluginEndpointNoContent ", 204)
}

func (o *ValidateCreatePluginEndpointNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewValidateCreatePluginEndpointBadRequest() *ValidateCreatePluginEndpointBadRequest {
	return &ValidateCreatePluginEndpointBadRequest{}
}
...
func (o *ValidateCreatePluginEndpointBadRequest) Error() string {
	return fmt.Sprintf("[POST /plugins/{id}/endpoints/validator][%d] validateCreatePluginEndpointBadRequest  %+v", 400, o.Payload)
}
...
func (o *ValidateCreatePluginEndpointBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
