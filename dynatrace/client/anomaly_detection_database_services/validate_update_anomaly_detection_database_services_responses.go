...
func (o *ValidateUpdateAnomalyDetectionDatabaseServicesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewValidateUpdateAnomalyDetectionDatabaseServicesNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewValidateUpdateAnomalyDetectionDatabaseServicesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewValidateUpdateAnomalyDetectionDatabaseServicesNoContent() *ValidateUpdateAnomalyDetectionDatabaseServicesNoContent {
	return &ValidateUpdateAnomalyDetectionDatabaseServicesNoContent{}
}
...
func (o *ValidateUpdateAnomalyDetectionDatabaseServicesNoContent) Error() string {
	return fmt.Sprintf("[POST /anomalyDetection/databaseServices/validator][%d] validateUpdateAnomalyDetectionDatabaseServicesNoContent ", 204)
}

func (o *ValidateUpdateAnomalyDetectionDatabaseServicesNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewValidateUpdateAnomalyDetectionDatabaseServicesBadRequest() *ValidateUpdateAnomalyDetectionDatabaseServicesBadRequest {
	return &ValidateUpdateAnomalyDetectionDatabaseServicesBadRequest{}
}
...
func (o *ValidateUpdateAnomalyDetectionDatabaseServicesBadRequest) Error() string {
	return fmt.Sprintf("[POST /anomalyDetection/databaseServices/validator][%d] validateUpdateAnomalyDetectionDatabaseServicesBadRequest  %+v", 400, o.Payload)
}
...
func (o *ValidateUpdateAnomalyDetectionDatabaseServicesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
