...
// NewGetAnomalyDetectionServicesParams creates a new GetAnomalyDetectionServicesParams object
// with the default values initialized.
func NewGetAnomalyDetectionServicesParams() *GetAnomalyDetectionServicesParams {

	return &GetAnomalyDetectionServicesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAnomalyDetectionServicesParamsWithTimeout creates a new GetAnomalyDetectionServicesParams object
...
// NewGetAnomalyDetectionServicesParamsWithContext creates a new GetAnomalyDetectionServicesParams object
...
// NewGetAnomalyDetectionServicesParamsWithHTTPClient creates a new GetAnomalyDetectionServicesParams object
...
/*GetAnomalyDetectionServicesParams contains all the parameters to send to the API endpoint
for the get anomaly detection services operation typically these are written to a http.Request
*/
