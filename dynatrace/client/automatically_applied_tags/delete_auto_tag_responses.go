...
func (o *DeleteAutoTagReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteAutoTagNoContent()
...
func (o *DeleteAutoTagNoContent) Error() string {
	return fmt.Sprintf("[DELETE /autoTags/{id}][%d] deleteAutoTagNoContent ", 204)
}

func (o *DeleteAutoTagNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
