...
func (o *GetAnomalyDetectionDiskEventReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetAnomalyDetectionDiskEventOK()
...
func NewGetAnomalyDetectionDiskEventOK() *GetAnomalyDetectionDiskEventOK {
	return &GetAnomalyDetectionDiskEventOK{}
}
...
func (o *GetAnomalyDetectionDiskEventOK) Error() string {
	return fmt.Sprintf("[GET /anomalyDetection/diskEvents/{id}][%d] getAnomalyDetectionDiskEventOK  %+v", 200, o.Payload)
}
...
func (o *GetAnomalyDetectionDiskEventOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(dynatrace.DiskEventAnomalyDetectionConfig)
