...
// NewGetDataPrivacyParams creates a new GetDataPrivacyParams object
// with the default values initialized.
func NewGetDataPrivacyParams() *GetDataPrivacyParams {

	return &GetDataPrivacyParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetDataPrivacyParamsWithTimeout creates a new GetDataPrivacyParams object
...
// NewGetDataPrivacyParamsWithContext creates a new GetDataPrivacyParams object
...
// NewGetDataPrivacyParamsWithHTTPClient creates a new GetDataPrivacyParams object
...
/*GetDataPrivacyParams contains all the parameters to send to the API endpoint
for the get data privacy operation typically these are written to a http.Request
*/
...
func (o *GetDataPrivacyParams) WithContext(ctx context.Context) *GetDataPrivacyParams {
	o.SetContext(ctx)
	return o
}
