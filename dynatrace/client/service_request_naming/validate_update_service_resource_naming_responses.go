...
func (o *ValidateUpdateServiceResourceNamingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewValidateUpdateServiceResourceNamingNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewValidateUpdateServiceResourceNamingBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewValidateUpdateServiceResourceNamingNoContent() *ValidateUpdateServiceResourceNamingNoContent {
	return &ValidateUpdateServiceResourceNamingNoContent{}
}
...
func (o *ValidateUpdateServiceResourceNamingNoContent) Error() string {
	return fmt.Sprintf("[POST /service/resourceNaming/validator][%d] validateUpdateServiceResourceNamingNoContent ", 204)
}

func (o *ValidateUpdateServiceResourceNamingNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewValidateUpdateServiceResourceNamingBadRequest() *ValidateUpdateServiceResourceNamingBadRequest {
	return &ValidateUpdateServiceResourceNamingBadRequest{}
}
...
func (o *ValidateUpdateServiceResourceNamingBadRequest) Error() string {
	return fmt.Sprintf("[POST /service/resourceNaming/validator][%d] validateUpdateServiceResourceNamingBadRequest  %+v", 400, o.Payload)
}
...
func (o *ValidateUpdateServiceResourceNamingBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
