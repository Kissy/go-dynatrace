...
// TagComparisonInfo tag comparison info
// swagger:model TagComparisonInfo
...
func (m *TagComparisonInfo) validateComparison(formats strfmt.Registry) error {
...
func (m *TagComparisonInfo) validateNegate(formats strfmt.Registry) error {
