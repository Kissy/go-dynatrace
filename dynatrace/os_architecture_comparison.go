...
// OsArchitectureComparison os architecture comparison
// swagger:model OsArchitectureComparison
...
func (m *OsArchitectureComparison) Type() string {
	return "OsArchitectureComparison"
}
...
func (m *OsArchitectureComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *OsArchitectureComparison) validateOperator(formats strfmt.Registry) error {
...
func (m *OsArchitectureComparison) UnmarshalBinary(b []byte) error {
	var res OsArchitectureComparison
