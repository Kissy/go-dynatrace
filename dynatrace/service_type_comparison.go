...
// ServiceTypeComparison service type comparison
// swagger:model ServiceTypeComparison
...
func (m *ServiceTypeComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *ServiceTypeComparison) validateOperator(formats strfmt.Registry) error {
