...
// swagger:model RdsHighCpuDetectionConfig
...
// Validate validates this rds high Cpu detection config
func (m *RdsHighCPUDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RdsHighCPUDetectionConfig) validateCustomThresholds(formats strfmt.Registry) error {
...
func (m *RdsHighCPUDetectionConfig) validateEnabled(formats strfmt.Registry) error {
...
func (m *RdsHighCPUDetectionConfig) UnmarshalBinary(b []byte) error {
	var res RdsHighCPUDetectionConfig
