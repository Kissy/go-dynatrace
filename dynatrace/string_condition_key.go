...
// StringConditionKey string condition key
// swagger:model StringConditionKey
...
// Validate validates this string condition key
...
var stringConditionKeyTypeAttributePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		stringConditionKeyTypeAttributePropEnum = append(stringConditionKeyTypeAttributePropEnum, v)
	}
}

// property enum
func (m *StringConditionKey) validateAttributeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, stringConditionKeyTypeAttributePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *StringConditionKey) validateAttribute(formats strfmt.Registry) error {
...
func (m *StringConditionKey) validateDynamicKey(formats strfmt.Registry) error {
