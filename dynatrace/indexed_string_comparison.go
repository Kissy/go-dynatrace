...
// IndexedStringComparison indexed string comparison
// swagger:model IndexedStringComparison
...
func (m *IndexedStringComparison) Type() string {
	return "IndexedStringComparison"
}
...
func (m *IndexedStringComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *IndexedStringComparison) validateOperator(formats strfmt.Registry) error {
...
func (m *IndexedStringComparison) UnmarshalBinary(b []byte) error {
	var res IndexedStringComparison
