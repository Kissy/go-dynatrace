...
// swagger:model IntegerComparison
...
func (m *IntegerComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *IntegerComparison) validateOperator(formats strfmt.Registry) error {
