...
// AzureSkuComparision azure sku comparision
// swagger:model AzureSkuComparision
...
func (m *AzureSkuComparision) validateNegate(formats strfmt.Registry) error {
...
func (m *AzureSkuComparision) validateOperator(formats strfmt.Registry) error {
