...
// BooleanComparisonInfo boolean comparison info
// swagger:model BooleanComparisonInfo
...
func (m *BooleanComparisonInfo) validateComparison(formats strfmt.Registry) error {
...
func (m *BooleanComparisonInfo) validateNegate(formats strfmt.Registry) error {
