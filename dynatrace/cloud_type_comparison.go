...
// CloudTypeComparison cloud type comparison
// swagger:model CloudTypeComparison
...
func (m *CloudTypeComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *CloudTypeComparison) validateOperator(formats strfmt.Registry) error {
