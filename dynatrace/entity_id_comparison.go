...
// EntityIDComparison entity Id comparison
// swagger:model EntityIdComparison
...
func (m *EntityIDComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *EntityIDComparison) validateOperator(formats strfmt.Registry) error {
