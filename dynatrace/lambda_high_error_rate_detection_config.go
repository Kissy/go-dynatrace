...
// swagger:model LambdaHighErrorRateDetectionConfig
...
// Validate validates this lambda high error rate detection config
func (m *LambdaHighErrorRateDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LambdaHighErrorRateDetectionConfig) validateCustomThresholds(formats strfmt.Registry) error {
...
func (m *LambdaHighErrorRateDetectionConfig) validateEnabled(formats strfmt.Registry) error {
...
func (m *LambdaHighErrorRateDetectionConfig) UnmarshalBinary(b []byte) error {
	var res LambdaHighErrorRateDetectionConfig
