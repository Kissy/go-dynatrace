...
// swagger:model HighMemoryDetectionConfig
...
// Validate validates this high memory detection config
func (m *HighMemoryDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HighMemoryDetectionConfig) validateCustomThresholds(formats strfmt.Registry) error {
...
func (m *HighMemoryDetectionConfig) validateEnabled(formats strfmt.Registry) error {
...
func (m *HighMemoryDetectionConfig) UnmarshalBinary(b []byte) error {
	var res HighMemoryDetectionConfig
