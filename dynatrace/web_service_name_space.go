...
// swagger:model WebServiceNameSpace
...
func (m *WebServiceNameSpace) UnmarshalJSON(raw []byte) error {
	...
	var result WebServiceNameSpace
...
// Validate validates this web service name space
...
func (m *WebServiceNameSpace) validateTransformations(formats strfmt.Registry) error {
