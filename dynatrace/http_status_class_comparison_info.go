...
// HTTPStatusClassComparisonInfo Http status class comparison info
// swagger:model HttpStatusClassComparisonInfo
...
func (m *HTTPStatusClassComparisonInfo) Type() string {
	return "HttpStatusClassComparisonInfo"
}
...
func (m *HTTPStatusClassComparisonInfo) validateComparison(formats strfmt.Registry) error {
...
func (m *HTTPStatusClassComparisonInfo) validateNegate(formats strfmt.Registry) error {
...
func (m *HTTPStatusClassComparisonInfo) UnmarshalBinary(b []byte) error {
	var res HTTPStatusClassComparisonInfo
