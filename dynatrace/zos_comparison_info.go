...
// ZosComparisonInfo zos comparison info
// swagger:model ZosComparisonInfo
...
func (m *ZosComparisonInfo) validateComparison(formats strfmt.Registry) error {
...
func (m *ZosComparisonInfo) validateNegate(formats strfmt.Registry) error {
