...
// EndsWithCompareOperation ends with compare operation
// swagger:model EndsWithCompareOperation
...
func (m *EndsWithCompareOperation) Type() string {
	return "EndsWithCompareOperation"
}
...
// Validate validates this ends with compare operation
...
func (m *EndsWithCompareOperation) validateValues(formats strfmt.Registry) error {
...
func (m *EndsWithCompareOperation) UnmarshalBinary(b []byte) error {
	var res EndsWithCompareOperation
