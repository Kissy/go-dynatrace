...
// swagger:model RdsHighMemoryDetectionConfig
...
// Validate validates this rds high memory detection config
func (m *RdsHighMemoryDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RdsHighMemoryDetectionConfig) validateCustomThresholds(formats strfmt.Registry) error {
...
func (m *RdsHighMemoryDetectionConfig) validateEnabled(formats strfmt.Registry) error {
...
func (m *RdsHighMemoryDetectionConfig) UnmarshalBinary(b []byte) error {
	var res RdsHighMemoryDetectionConfig
