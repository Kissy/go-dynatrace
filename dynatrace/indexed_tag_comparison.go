...
// IndexedTagComparison indexed tag comparison
// swagger:model IndexedTagComparison
...
func (m *IndexedTagComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *IndexedTagComparison) validateOperator(formats strfmt.Registry) error {
