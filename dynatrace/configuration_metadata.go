...
// swagger:model ConfigurationMetadata
...
// Validate validates this configuration metadata
func (m *ConfigurationMetadata) Validate(formats strfmt.Registry) error {
	return nil
}
