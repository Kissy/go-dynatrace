...
// BitnessComparision bitness comparision
// swagger:model BitnessComparision
...
func (m *BitnessComparision) validateNegate(formats strfmt.Registry) error {
...
func (m *BitnessComparision) validateOperator(formats strfmt.Registry) error {
