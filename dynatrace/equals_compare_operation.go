...
// EqualsCompareOperation equals compare operation
// swagger:model EqualsCompareOperation
...
// Validate validates this equals compare operation
...
func (m *EqualsCompareOperation) validateValues(formats strfmt.Registry) error {
...
func (m *EqualsCompareOperation) UnmarshalBinary(b []byte) error {
	var res EqualsCompareOperation
