...
// HypervisorTypeComparision hypervisor type comparision
// swagger:model HypervisorTypeComparision
...
func (m *HypervisorTypeComparision) Type() string {
	return "HypervisorTypeComparision"
}
...
func (m *HypervisorTypeComparision) validateNegate(formats strfmt.Registry) error {
...
func (m *HypervisorTypeComparision) validateOperator(formats strfmt.Registry) error {
...
func (m *HypervisorTypeComparision) UnmarshalBinary(b []byte) error {
	var res HypervisorTypeComparision
