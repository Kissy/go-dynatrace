...
// HostNameAlertingScope host name alerting scope
// swagger:model HostNameAlertingScope
...
// Validate validates this host name alerting scope
...
func (m *HostNameAlertingScope) validateNameFilter(formats strfmt.Registry) error {
