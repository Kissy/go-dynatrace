...
// PaasTypeComparison paas type comparison
// swagger:model PaasTypeComparison
...
func (m *PaasTypeComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *PaasTypeComparison) validateOperator(formats strfmt.Registry) error {
