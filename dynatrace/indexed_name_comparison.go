...
// IndexedNameComparison indexed name comparison
// swagger:model IndexedNameComparison
...
func (m *IndexedNameComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *IndexedNameComparison) validateOperator(formats strfmt.Registry) error {
