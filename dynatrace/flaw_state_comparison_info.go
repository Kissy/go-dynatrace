...
// FlawStateComparisonInfo flaw state comparison info
// swagger:model FlawStateComparisonInfo
...
func (m *FlawStateComparisonInfo) Type() string {
	return "FlawStateComparisonInfo"
}
...
func (m *FlawStateComparisonInfo) validateComparison(formats strfmt.Registry) error {
...
func (m *FlawStateComparisonInfo) validateNegate(formats strfmt.Registry) error {
...
func (m *FlawStateComparisonInfo) UnmarshalBinary(b []byte) error {
	var res FlawStateComparisonInfo
