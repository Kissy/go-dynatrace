...
// FailedStateComparisonInfo failed state comparison info
// swagger:model FailedStateComparisonInfo
...
func (m *FailedStateComparisonInfo) Type() string {
	return "FailedStateComparisonInfo"
}
...
func (m *FailedStateComparisonInfo) validateComparison(formats strfmt.Registry) error {
...
func (m *FailedStateComparisonInfo) validateNegate(formats strfmt.Registry) error {
...
func (m *FailedStateComparisonInfo) UnmarshalBinary(b []byte) error {
	var res FailedStateComparisonInfo
