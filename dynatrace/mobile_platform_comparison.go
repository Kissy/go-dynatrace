...
// swagger:model MobilePlatformComparison
...
func (m *MobilePlatformComparison) Type() string {
	return "MobilePlatformComparison"
}
...
func (m *MobilePlatformComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *MobilePlatformComparison) validateOperator(formats strfmt.Registry) error {
...
func (m *MobilePlatformComparison) UnmarshalBinary(b []byte) error {
	var res MobilePlatformComparison
