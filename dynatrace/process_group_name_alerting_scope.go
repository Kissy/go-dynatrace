...
// ProcessGroupNameAlertingScope process group name alerting scope
// swagger:model ProcessGroupNameAlertingScope
...
func (m *ProcessGroupNameAlertingScope) FilterType() string {
	return "ProcessGroupNameAlertingScope"
}
...
// Validate validates this process group name alerting scope
...
func (m *ProcessGroupNameAlertingScope) validateNameFilter(formats strfmt.Registry) error {
...
func (m *ProcessGroupNameAlertingScope) UnmarshalBinary(b []byte) error {
	var res ProcessGroupNameAlertingScope
