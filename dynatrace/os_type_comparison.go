...
// OsTypeComparison os type comparison
// swagger:model OsTypeComparison
...
func (m *OsTypeComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *OsTypeComparison) validateOperator(formats strfmt.Registry) error {
