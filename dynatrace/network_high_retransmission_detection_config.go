...
// swagger:model NetworkHighRetransmissionDetectionConfig
...
// Validate validates this network high retransmission detection config
func (m *NetworkHighRetransmissionDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NetworkHighRetransmissionDetectionConfig) validateCustomThresholds(formats strfmt.Registry) error {
...
func (m *NetworkHighRetransmissionDetectionConfig) validateEnabled(formats strfmt.Registry) error {
...
func (m *NetworkHighRetransmissionDetectionConfig) UnmarshalBinary(b []byte) error {
	var res NetworkHighRetransmissionDetectionConfig
