...
// swagger:model DatabaseAnomalyDetectionConfig
...
// Validate validates this database anomaly detection config
func (m *DatabaseAnomalyDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error

	if err := m.validateDatabaseConnectionFailureCount(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DatabaseAnomalyDetectionConfig) validateDatabaseConnectionFailureCount(formats strfmt.Registry) error {

	if err := validate.Required("databaseConnectionFailureCount", "body", m.DatabaseConnectionFailureCount); err != nil {
		return err
	}

	if m.DatabaseConnectionFailureCount != nil {
		if err := m.DatabaseConnectionFailureCount.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("databaseConnectionFailureCount")
			}
			return err
		}
	}
...
func (m *DatabaseAnomalyDetectionConfig) validateFailureRateIncrease(formats strfmt.Registry) error {
...
func (m *DatabaseAnomalyDetectionConfig) validateMetadata(formats strfmt.Registry) error {
...
func (m *DatabaseAnomalyDetectionConfig) validateResponseTimeDegradation(formats strfmt.Registry) error {
...
func (m *DatabaseAnomalyDetectionConfig) UnmarshalBinary(b []byte) error {
	var res DatabaseAnomalyDetectionConfig
