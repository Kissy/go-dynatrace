...
// SimpleTechComparison simple tech comparison
// swagger:model SimpleTechComparison
...
func (m *SimpleTechComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *SimpleTechComparison) validateOperator(formats strfmt.Registry) error {
