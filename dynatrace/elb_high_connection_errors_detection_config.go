...
// swagger:model ElbHighConnectionErrorsDetectionConfig
...
// Validate validates this elb high connection errors detection config
func (m *ElbHighConnectionErrorsDetectionConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ElbHighConnectionErrorsDetectionConfig) validateCustomThresholds(formats strfmt.Registry) error {
...
func (m *ElbHighConnectionErrorsDetectionConfig) validateEnabled(formats strfmt.Registry) error {
...
func (m *ElbHighConnectionErrorsDetectionConfig) UnmarshalBinary(b []byte) error {
	var res ElbHighConnectionErrorsDetectionConfig
