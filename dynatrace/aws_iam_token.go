...
// Validate validates this aws iam token
func (m *AwsIamToken) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsIamToken) validateToken(formats strfmt.Registry) error {
