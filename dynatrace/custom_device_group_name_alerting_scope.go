...
// CustomDeviceGroupNameAlertingScope custom device group name alerting scope
// swagger:model CustomDeviceGroupNameAlertingScope
...
func (m *CustomDeviceGroupNameAlertingScope) FilterType() string {
	return "CustomDeviceGroupNameAlertingScope"
}
...
// Validate validates this custom device group name alerting scope
...
func (m *CustomDeviceGroupNameAlertingScope) validateNameFilter(formats strfmt.Registry) error {
...
func (m *CustomDeviceGroupNameAlertingScope) UnmarshalBinary(b []byte) error {
	var res CustomDeviceGroupNameAlertingScope
