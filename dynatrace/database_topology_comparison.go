...
// DatabaseTopologyComparison database topology comparison
// swagger:model DatabaseTopologyComparison
...
func (m *DatabaseTopologyComparison) Type() string {
	return "DatabaseTopologyComparison"
}
...
func (m *DatabaseTopologyComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *DatabaseTopologyComparison) validateOperator(formats strfmt.Registry) error {
...
func (m *DatabaseTopologyComparison) UnmarshalBinary(b []byte) error {
	var res DatabaseTopologyComparison
