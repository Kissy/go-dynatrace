...
// ApplicationTypeComparison application type comparison
// swagger:model ApplicationTypeComparison
...
func (m *ApplicationTypeComparison) Type() string {
	return "ApplicationTypeComparison"
}
...
func (m *ApplicationTypeComparison) validateNegate(formats strfmt.Registry) error {
...
func (m *ApplicationTypeComparison) validateOperator(formats strfmt.Registry) error {
...
func (m *ApplicationTypeComparison) UnmarshalBinary(b []byte) error {
	var res ApplicationTypeComparison
